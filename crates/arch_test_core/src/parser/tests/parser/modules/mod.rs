...
fn inner_modules() {
    ...
    assert_eq!(
        node_tree[1].usable_objects[0].object_type(),
        ObjectType::Struct
    );
    assert_eq!(
        node_tree[1].usable_objects[0].object_name,
        "Test1".to_owned()
    );
    assert_eq!(
        node_tree[1].usable_objects[1].object_type(),
        ObjectType::Struct
    );
    assert_eq!(
        node_tree[1].usable_objects[1].object_name,
        "Test1_2".to_owned()
    );
    ...
    assert_eq!(
        node_tree[2].usable_objects[0].object_type(),
        ObjectType::Struct
    );
    assert_eq!(
        node_tree[2].usable_objects[0].object_name,
        "Test2".to_owned()
    );
    ...
    assert_eq!(
        node_tree[3].usable_objects[0].object_type(),
        ObjectType::Struct
    );
    assert_eq!(
        node_tree[3].usable_objects[0].object_name,
        "Test3".to_owned()
    );
}
